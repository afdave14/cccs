...
def createBoard():
    ...
    #Quadrant 2 block 2
    aBoard.append([(30*RATIO,6*RATIO),(30*RATIO,8*RATIO),(36*RATIO,8*RATIO),(36*RATIO,6*RATIO)])#[2,0] was 34
    #Quadrant 2 block 3
    ...
    #Quadrant 2 block 4
    aBoard.append([(30*RATIO,11*RATIO),(30*RATIO,12*RATIO),(36*RATIO,12*RATIO),(36*RATIO,11*RATIO)])
    ...
    #Quadrant 3 block 3
    aBoard.append([(30*RATIO,31*RATIO),(30*RATIO,36*RATIO),(31*RATIO,36*RATIO),(31*RATIO,32*RATIO),(36*RATIO,32*RATIO),(36*RATIO,31*RATIO)])
    #Quadrant 4 block 4
...
def createBoarder():
    ...
    aBoarder.append([(0,23*RATIO),(7*RATIO, 23*RATIO),(7*RATIO, 28*RATIO),(0, 28*RATIO),(0,35*RATIO),(3*RATIO,35*RATIO),(3*RATIO,RATIO*36),
             (0,RATIO*36),(0,RATIO*43),(WIDTH-RATIO,RATIO*43),(WIDTH-RATIO,RATIO*36),(WIDTH-(RATIO*6),RATIO*36),(WIDTH-(RATIO*6),RATIO*35),
             (WIDTH-RATIO,RATIO*35),(WIDTH-RATIO,RATIO*28),(RATIO*30,RATIO*28),(30*RATIO,RATIO*23),(WIDTH-RATIO,RATIO*23),])
    #draws top boarder
    aBoarder.append([(0,RATIO*20),(7*RATIO,RATIO*20),(7*RATIO, RATIO*15),(0, RATIO*15),(0,3*RATIO),(18*RATIO, 3*RATIO),(18*RATIO, 8*RATIO),
             (19*RATIO, 8*RATIO),(19*RATIO,3*RATIO),(WIDTH-RATIO,3*RATIO),(WIDTH-RATIO,RATIO*15),(RATIO*30,RATIO*15),(RATIO*30,RATIO*20),(WIDTH-RATIO,RATIO*20)])
    return(aBoarder)
################################################################
...
def canMove():
    ...
    elif (pacmanrect.x > can_move[2][0] and pacmanrect.x < WIDTH-RATIO and pacmanrect.y == 20.5*RATIO):
        return True
    ...
    elif (pacmanrect.x > 266 and pacmanrect.x < 518 and pacmanrect.y == 49):
        return True
    ...
    elif (pacmanrect.x > 0 and pacmanrect.x < 518 and pacmanrect.y == 119):
        return True
    #very top right down
    ...
    #bottom left, first column, last portion
        ...
        return True
    #very bottom row
    elif (pacmanrect.x > 7 and pacmanrect.x < 518 and pacmanrect.y == 567):
        return True
    ...
    elif (pacmanrect.x > 266 and pacmanrect.x < 518 and pacmanrect.y == 399):
        return True
    ...
    elif (pacmanrect.x > 385 and pacmanrect.x < 518 and pacmanrect.y == 511):
        return True
