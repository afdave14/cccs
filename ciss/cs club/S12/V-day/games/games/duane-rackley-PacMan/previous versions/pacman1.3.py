...
while 1:
    ...
    can_move = [(11.75*RATIO,24.5*RATIO),(23.25*RATIO,24.5*RATIO),(23.5*RATIO, 16.5*RATIO),(23.5*RATIO, 16.5*RATIO)]
    #########################################
    ...
    elif (pacmanrect.y < can_move[0][1] and pacmanrect.y > can_move[2][1] and pacmanrect.x == can_move[2][0]):
        pass
    #left from  the top of them middle
    elif (pacmanrect.x > can_move[0][0] and pacmanrect.x < can_move[3][0] and pacmanrect.y == can_move[2][1]):
        pass
    #down on the left in the middle
    elif (pacmanrect.y < can_move[0][1] and pacmanrect.y > can_move[2][1] and pacmanrect.x == 11.5*RATIO):
        pass
