...
while 1:
    ...
    #drawing board
    #draws top boarder
    alist = [(0,RATIO*20),(7*RATIO,RATIO*20),(7*RATIO, RATIO*15),(0, RATIO*15),(0,3*RATIO),(18*RATIO, 3*RATIO),(18*RATIO, 8*RATIO),
    ...
    #draws bottom border
    blist = [(0,23*RATIO),(7*RATIO, 23*RATIO),(7*RATIO, 28*RATIO),(0, 28*RATIO),(0,35*RATIO),(3*RATIO,35*RATIO),(3*RATIO,RATIO*36),
    ...
    #Quadrant 3 block 1
    q3b1 = [(10*RATIO,23*RATIO),(10*RATIO,28*RATIO),(11*RATIO,28*RATIO),(11*RATIO,23*RATIO)]
    #Quadrant 3 block 2
    q3b2 = [(3*RATIO,31*RATIO),(3*RATIO,32*RATIO),(6*RATIO,32*RATIO),(6*RATIO,36*RATIO),(7*RATIO,36*RATIO),(7*RATIO,31*RATIO)]
    #Quadrant 3 block 3
    q3b3 = [(10*RATIO,31*RATIO),(10*RATIO,32*RATIO),(15*RATIO,32*RATIO),(15*RATIO,31*RATIO)]
    #Quadrant 3 block 4
    q3b4 = [(10*RATIO,35*RATIO),(10*RATIO,39*RATIO),(3*RATIO,39*RATIO),(3*RATIO,40*RATIO),(RATIO*15,RATIO*40),(15*RATIO,39*RATIO),(11*RATIO,39*RATIO),
            (11*RATIO,35*RATIO)]
    #Quadrant 3 block 5
    q3b5 = [(14*RATIO,27*RATIO),(14*RATIO,28*RATIO),(18*RATIO,28*RATIO),(18*RATIO,32*RATIO),(RATIO*19,RATIO*32),(19*RATIO,28*RATIO),(23*RATIO,28*RATIO),
            (23*RATIO,27*RATIO)]
    #Quadrant 3 block 6
    q3b6 = [(14*RATIO,35*RATIO),(14*RATIO,36*RATIO),(18*RATIO,36*RATIO),(18*RATIO,40*RATIO),(RATIO*19,RATIO*40),(19*RATIO,36*RATIO),(23*RATIO,36*RATIO),
            (23*RATIO,35*RATIO)]
    #Quadrant 4 block 1
    q4b1 = [(26*RATIO,23*RATIO),(26*RATIO,28*RATIO),(27*RATIO,28*RATIO),(27*RATIO,23*RATIO)]
    #Quadrant 4 block 2
    q4b2 = [(22*RATIO,31*RATIO),(22*RATIO,32*RATIO),(27*RATIO,32*RATIO),(27*RATIO,31*RATIO)]
    #Quadrant 3 block 3
    q4b3 = [(30*RATIO,31*RATIO),(30*RATIO,36*RATIO),(31*RATIO,36*RATIO),(31*RATIO,32*RATIO),(34*RATIO,32*RATIO),(34*RATIO,31*RATIO)]
    #Quadrant 4 block 4
    q4b4 = [(26*RATIO,35*RATIO),(26*RATIO,39*RATIO),(22*RATIO,39*RATIO),(22*RATIO,40*RATIO),(RATIO*36,RATIO*40),(36*RATIO,39*RATIO),(27*RATIO,39*RATIO),
            (27*RATIO,35*RATIO)]
    ...
    pygame.draw.lines(surface, (0,0,255),True, q3b1, 3)
    pygame.draw.lines(surface, (0,0,255),True, q3b2, 3)
    pygame.draw.lines(surface, (0,0,255),True, q3b3, 3)
    pygame.draw.lines(surface, (0,0,255),True, q3b4, 3)
    pygame.draw.lines(surface, (0,0,255),True, q3b5, 3)
    pygame.draw.lines(surface, (0,0,255),True, q3b6, 3)
    pygame.draw.lines(surface, (0,0,255),True, q4b1, 3)
    pygame.draw.lines(surface, (0,0,255),True, q4b2, 3)
    pygame.draw.lines(surface, (0,0,255),True, q4b3, 3)
    pygame.draw.lines(surface, (0,0,255),True, q4b4, 3)
