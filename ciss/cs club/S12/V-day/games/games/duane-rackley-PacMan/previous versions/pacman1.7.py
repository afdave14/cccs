...
##        #2-4 first column
    ...
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    singleDot = singleDot.move(RATIO+5+(518/26)*5, (6.5*RATIO)+518/26)
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    ...
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    singleDot = singleDot.move(RATIO+5+(518/26)*11, (6.5*RATIO)+518/26)
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    ...
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    singleDot = singleDot.move(RATIO+5+(518/26)*20, (6.5*RATIO)+518/26)
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    ...
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
    singleDot = singleDot.move(RATIO+5+(518/26)*14, (6.5*RATIO)+518/26)
    dotArray.append(singleDot)
    singleDot = dot.get_rect()
